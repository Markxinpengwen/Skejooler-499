...
class CreateRequestsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Module::generate("Requests", 'requests', 'rid', 'fa-building-o', [
			...
			["sid", "sid", "Integer", false, "", 6, 6, true], //first bool (iUnique) to false //TODO change seeder //!@#
			["cid", "cid", "Integer", false, "", 6, 6, true], //first bool (iUnique) to false //TODO change seeder //!@#
